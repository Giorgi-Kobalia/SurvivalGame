...
export const ITEMS = {
    ...
    fries:    { name: "Fries",    icon: null, emoji: "🍳",     value: 0,  heals: 25 },
};

export const RECIPES = {
    bread: { needs: { wheat: 3 },            heals: 30, name: "Bread", result: "bread" },
    soup:  { needs: { tomato: 2 },           heals: 40, name: "Soup",  result: "soup"  },
    fries: { needs: { tomato: 1, wheat: 1 }, heals: 25, name: "Fries", result: "fries" },
};
